...
-   Create two apps on Fly, one for staging and one for production:
    ...
    ```sh
    fly create rockabilly-test-c1ab
    fly create rockabilly-test-c1ab-staging
    ```
...
-   Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
    ...
    ```sh
    fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rockabilly-test-c1ab
    fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rockabilly-test-c1ab-staging
    ```
...
-   Create a single Postgres server and attach it to both production and staging apps:
    ...
    ```sh
    fly postgres create --name rockabilly-test-c1ab-db
    fly postgres attach --postgres-app rockabilly-test-c1ab-db --app rockabilly-test-c1ab
    fly postgres attach --postgres-app rockabilly-test-c1ab-db --app rockabilly-test-c1ab-staging
    ```
    ...
    ```sh
    fly postgres create --name rockabilly-test-c1ab-db
    fly postgres create --name rockabilly-test-c1ab-staging-db
    fly postgres attach --postgres-app rockabilly-test-c1ab-db --app rockabilly-test-c1ab
    fly postgres attach --postgres-app rockabilly-test-c1ab-staging-db --app rockabilly-test-c1ab-staging
    ```
